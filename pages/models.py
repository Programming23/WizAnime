...
class Anime(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('anime', args=[self.name.replace(' ', '-')])
    ...
    def last_episode(self):
        return self.episodes_set.latest('id')
...
class Episodes(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('watch', args=[self.name.url_anime, self.name.anime_type.type_url, self.episode])
